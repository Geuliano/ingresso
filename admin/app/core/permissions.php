...
function userHasPermission($userId, $moduleIdentifier, $tipo = 'pode_visualizar')
{
    ...
    // Whitelist explícita — impede uso de $tipo como vetor de SQL injection
    $tiposPermitidos = ['pode_visualizar', 'pode_criar', 'pode_editar', 'pode_excluir'];
